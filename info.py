...
BOT_TOKEN = environ.get('BOT_TOKEN', "5740026879:AAF7UP0szx6QEICpiuGlQShlmjeHziI4e2Y")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001867571766').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/doopautof')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/doopautof')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/doopautof')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001867571766))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001867571766))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/doopautof')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/doopautof')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001867571766))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001867571766))
